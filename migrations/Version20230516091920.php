 ...
 */
final class Version20230516091920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(30) NOT NULL, firstname VARCHAR(30) DEFAULT NULL, phone_number INT DEFAULT NULL, administrator TINYINT(1) NOT NULL, actif TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649AF5D55E1 (campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT NOT NULL, ADD campus_origine_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_3C3FD3F2D6A22102 ON sortie (campus_origine_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3C3FD3F2D6A22102 ON sortie');
        $this->addSql('ALTER TABLE sortie DROP organisateur_id, DROP campus_origine_id');
    }
}
