...
final class Version20230523083809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photos (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, nom_fichier VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, INDEX IDX_876E0D9FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
